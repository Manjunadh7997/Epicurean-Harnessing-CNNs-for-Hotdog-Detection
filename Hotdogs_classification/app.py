...
def predict():    
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            print(prediction)
            label = 'Hotdog Enjoy the hotdog in each bite and taste few more in hotdogs. ' if prediction[0][0] < 0.5 else 'Not a Hotdog,  If you wish to eat click on home and choose the hotdog from the Menu '
